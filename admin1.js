// ==================================================
// ADMIN PANEL - MAIN JAVASCRIPT (ID-BASED ROUTING)
// ==================================================
...
function getFormData() {
 ...
 formData.append(
    'hero_image',
    document.getElementById('heroImage').value.trim()
);
...
if (project.hero_image) {
    ...
    if (preview) {
        preview.innerHTML = `
            <img src="${project.hero_image}" alt="Hero">
        `;
    }
}
            if (project.banner_image) {
                const preview = document.getElementById('bannerImagePreview');
                if (preview) preview.innerHTML = `<img src="${project.banner_image}" alt="Banner" />`;
            }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('featuresContainer')) {
        // Check if features container is empty
...
console.log('🚀 Admin Panel loaded successfully! (ID-based routing)');